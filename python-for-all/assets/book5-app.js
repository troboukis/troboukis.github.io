    ...
    if (bannerSpan) bannerSpan.textContent = "Loading BeautifulSoup and pandas…";
    await pyodide.loadPackage(["beautifulsoup4", "pandas"]);
    ...
    const PY_BUILTINS = new Set([
      ...
      "isinstance", "BeautifulSoup", "soup", "tag", "re", "unicodedata", "hashlib"
    ]);
